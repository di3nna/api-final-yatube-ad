...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework.authtoken',          # Для работы токенов (нужно для djoser)
    'djoser',                            # Для работы с JWT
...
REST_FRAMEWORK = {
    ...
    #'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.LimitOffsetPagination',  # ← поменяли
    #'PAGE_SIZE': 10,
}
